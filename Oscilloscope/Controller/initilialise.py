...
class PicoScopeDevice:
    def __init__(self, config_file="Oscilloscope\config.yml"):
        self.chandle = None
    ...
    def get_timebase_info(self):
        # Set timebase to 8 which corresponds to 80 ns
        # This is the fastest timebase that can be used with the PicoScope 2205A
